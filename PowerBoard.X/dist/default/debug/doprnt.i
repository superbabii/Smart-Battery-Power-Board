...
static void dtoa(FILE *fp, vfpf_sint_t d)
{
 ...
 int p;
    ...
    s = d < 0 ? 1 : 0;
# 533 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\sources\\c99\\common\\doprnt.c"
    p = (0 <= prec) ? prec : 1;
...
static void stoa(FILE *fp, char *s)
{
 ...
 if (!(prec < 0) && (prec < l)) {
  l = prec;
    ...
    p = l;
# 979 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\sources\\c99\\common\\doprnt.c"
    while (p--) {
        fputc(*cp, fp);
        ++cp;
    }
# 997 "C:\\Program Files\\Microchip\\xc8\\v2.46\\pic\\sources\\c99\\common\\doprnt.c"
}
