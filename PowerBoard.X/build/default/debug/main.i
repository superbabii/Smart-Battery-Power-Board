...
# 81 "./mcc_generated_files/system/../adc/adc.h"
void ADC_Initialize(void);
# 90 "./mcc_generated_files/system/../adc/adc.h"
...
# 124 "./mcc_generated_files/system/../adc/adc.h"
adc_result_t ADC_GetConversion(adc_channel_t channel);
# 133 "./mcc_generated_files/system/../adc/adc.h"
...
# 63 "./mcc_generated_files/system/../pwm/ccp2.h"
...
float LM35_GetTemperature(void)
{
    ...
    adc_result_t adc_result = ADC_GetConversion(0);




    float voltage = (float)adc_result * (5.0f / 1023.0f);
...
void SendCommand(uint8_t command) {
    ...
    I2C1_Write(0x16, &command, sizeof(command));
}
...
uint16_t ReadData(void) {
    ...
    I2C1_Read(0x17, (uint8_t*)&data, sizeof(data));
    return data;
}
